...
class PlayerIdentity:
    ...
    def add_action(self, action_data: Dict):
        ...
        if action_data.get('action_type') in ['goal', 'red_card', 'yellow_card', 'penalty']:
            logger.info(f"⚽ SIGNIFICANT ACTION: {self.team} #{self.jersey_number} - {action_data['action_type']} at {self._format_time(action_data['timestamp'])}")
